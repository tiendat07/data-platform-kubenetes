...
SPARK_VERSION = get_spark_version() or "3.5.6"  # Assume 3.5.6 if not found
...
class SparkEnvConfiger:
    _basic = {
        ...
        "spark.executor.extraJavaOptions": ("SPARGLIM_EXECUTOR_JAVA_EXTRA_OPTIONS",None),
        "spark.sql.extensions": (
            "SPARGLIM_SQL_EXTENSIONS",
            "org.apache.iceberg.spark.extensions.IcebergSparkSessionExtensions",
        ),
        "spark.sql.catalog.lakehouse": (
            "SPARGLIM_SQL_CATALOG_LAKEHOUSE",
            "org.apache.iceberg.spark.SparkCatalog",
        ),
        "spark.sql.catalog.lakehouse.io-impl": (
            "SPARGLIM_SQL_CATALOG_LAKEHOUSE_IMPL",
            "org.apache.iceberg.aws.s3.S3FileIO",
        ),
        "spark.sql.catalog.lakehouse.warehouse": (
            "SPARGLIM_SQL_CATALOG_LAKEHOUSE_WAREHOUSE",
            "s3a://lakehouse/",
        ),
        ...
        "spark.sql.defaultCatalog": (
            "SPARGLIM_SQL_DEFAULT_CATALOG",
            "lakehouse",
        ),
        "spark.sql.catalogImplementation": (
            "SPARGLIM_SQL_CATALOG_IMPLEMENTATION",
            "in-memory",
        ),
        "spark.sql.catalog.lakehouse.type": (
            "SPARGLIM_SQL_CATALOG_LAKEHOUSE_TYPE",
            "rest",
        ),
        "spark.sql.catalog.lakehouse.uri": (
            "SPARGLIM_SQL_CATALOG_LAKEHOUSE_URI",
            "http://iceberg-rest-catalog.catalog.svc.cluster.local:8181",
        ),
        "spark.executor.heartbeatInterval": (
            "SPARGLIM_EXECUTOR_HEARTBEAT_INTERVAL",
            "300000",
        ),
        "spark.network.timeout": (
            "SPARGLIM_NETWORK_TIMEOUT",
            "400000",
        ),
    ...
    _history = {
        "spark.eventLog.enabled": ("SPARGLIM_EVENTLOG_ENABLED", "true"),
        "spark.eventLog.dir": ("SPARGLIM_EVENTLOG_DIR", "s3a://spark-logs/logs"),
        "spark.history.fs.logDirectory": ("SPARGLIM_HISTORY_LOG_DIR", None),
        "spark.history.ui.port": ("SPARGLIM_HISTORY_UI_PORT", None),
    }
    _s3 = {
